...
class Parser(object):
    def __init__(self):
        ...
        MNZ = Literal("MNZ").setParseAction(lambda t: int2binstr(0, length=4))
        MLZ = Literal("MLZ").setParseAction(lambda t: int2binstr(1, length=4))
        ADD = Literal("ADD").setParseAction(lambda t: int2binstr(2, length=4))
        SUB = Literal("SUB").setParseAction(lambda t: int2binstr(3, length=4))
        AND = Literal("AND").setParseAction(lambda t: int2binstr(4, length=4))
        OR =   Literal("OR").setParseAction(lambda t: int2binstr(5, length=4))
        XOR = Literal("XOR").setParseAction(lambda t: int2binstr(6, length=4))
        ANT = Literal("ANT").setParseAction(lambda t: int2binstr(7, length=4))
